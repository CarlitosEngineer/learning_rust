...
- Como ya sabemos, Las varaibles tiene un "TIPO DE DATO".
...
fn testing_datatypes_integers() {
    ...
    let variable_7 = 42; // i32 por defecto

    // Tambien se pueden nombrar las varaibles de otras forma, esta se llama sufijo.
